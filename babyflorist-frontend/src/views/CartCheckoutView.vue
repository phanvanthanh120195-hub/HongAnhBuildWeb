                ...
                <div class="col-lg-8 col-md-8">
                    <div class="checkout-form">
                        ...
                        <div class="payment-methods mb-3">
                            <div class="payment-option" :class="{ active: paymentMethod === 'bank' }"
                ...
                <div class="modal-body text-center">
                    <template v-if="!paymentExpired">
                        ...
                        <div class="transfer-details text-start bg-light p-3 rounded">
                            ...
                            <p><strong>Số tài khoản:</strong> <span class="text-primary">{{ selectedBank?.account_number
                                    }}</span></p>
                            <p><strong>Chủ tài khoản:</strong> {{ selectedBank?.account_name }}</p>
                            <p><strong>Số tiền:</strong> <span class="text-danger fw-bold">{{ formatPrice(finalPrice) }}
                                    đ</span></p>
