...
const posts = [
    {
        id: 1,
        title: 'Trải Nghiệm Lớp Học Cắm Hoa Cơ Bản Tại Hà Nội',
        description: 'Khóa học vỡ lòng cho những ai yêu hoa, bắt đầu từ cách chọn hoa tươi đến kỹ thuật cắm bình tròn.',
        ...
        category: 'Workshop',
        categoryClass: 'bg-white/95 dark:bg-black/80 text-primary',
        date: '10/01/2024'
    },
    {
        id: 2,
        title: 'Ý Nghĩa Của Việc Tặng Giỏ Quà Tết Tự Làm',
        description: 'Món quà tự tay gói ghém không chỉ thể hiện sự khéo léo mà còn chứa đựng tâm tình trân quý.',
        ...
        categoryClass: 'bg-white/95 dark:bg-black/80 text-amber-600',
        date: '08/01/2024'
    },
    {
        id: 3,
        title: 'Cách Chăm Sóc Lan Hồ Điệp Ra Hoa Quanh Năm',
        description: 'Lan Hồ Điệp được mệnh danh là nữ hoàng của các loại lan, nhưng chăm sóc sao cho đúng cách?',
    ...
    {
        id: 4,
        title: 'Mai Vàng Phú Quý - Biểu Tượng Của Sự May Mắn',
        description: 'Khám phá nguồn gốc và ý nghĩa phong thủy của loài hoa đặc trưng miền Nam mỗi dịp Tết đến.',
    ...
    {
        id: 5,
        title: 'Lớp Học Phối Màu Hoa Đương Đại',
        description: 'Học cách phối hợp màu sắc táo bạo nhưng vẫn giữ được nét tinh tế, sang trọng cho không gian.',
    ...
    {
        id: 6,
        title: 'Top 5 Mẫu Bình Hoa Phòng Khách Được Yêu Thích',
        description: 'Tổng hợp những mẫu bình gốm sứ Bát Tràng độc đáo làm tôn lên vẻ đẹp của mọi loài hoa.',
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDi6tu_PFakN_PMcVOPdSmhxAjsPDOLNhl5uWgTTXPDKNkJc-jJUWxQGTguI4wDmSW-RUWu6DsPM4Uz1YleOeWbxg9mvcmRpI8rAevEO_mVVUMCeI3SSs6nimydGbMi--7CDdL-Lv0oWsWs6JgdoCDRfHNk8DrQOM9zfIUnrXZU9WeH6lUwjYZq4sp5QWsr5pe9lt28bCb26rI5dvj9QAV2JVNHLkzt-ow5R2Gb5V4nTAp7yWMW34lF8e0EidXxeQHMfCqwlyAHOt8',
        category: 'Mẹo cắm hoa',
        categoryClass: 'bg-white/95 dark:bg-black/80 text-amber-600',
        date: '28/12/2023'
    }
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <article v-for="post in posts" :key="post.id" class="flex flex-col group h-full bg-transparent">
                    <div
                        ...
                        <div
                            :class="[post.categoryClass, 'absolute top-3 left-3 backdrop-blur-sm px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-wider shadow-sm']">
                            {{ post.category }}
                        </div>
                    </div>
