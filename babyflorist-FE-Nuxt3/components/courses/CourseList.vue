...
const courses = [
    {
        id: 1,
        title: 'Cắm Hoa Tết Cơ Bản',
        description: 'Khóa học nhập môn dành cho người mới, hướng dẫn cách chọn hoa tươi và kỹ thuật cắm bình tròn truyền thống.',
        price: '500.000đ',
    ...
    {
        id: 2,
        title: 'Workshop Giỏ Quà Tết',
        description: 'Tự tay gói những giỏ quà sang trọng, tinh tế tặng đối tác và người thân với sự hướng dẫn từ nghệ nhân.',
        price: '850.000đ',
    ...
    {
        id: 3,
        title: 'Nghệ Thuật Bình Hoa Đào',
        description: 'Kỹ thuật dưỡng hoa đào tươi lâu và tạo dáng thế cổ truyền mang lại vượng khí, tài lộc cho gia chủ.',
        price: '1.200.000đ',
    ...
    {
        id: 4,
        title: 'Thiết Kế Lan Hồ Điệp',
        description: 'Học cách phối ghép lan hồ điệp vào chậu lớn, tạo vẻ đẹp sang trọng, đẳng cấp cho phòng khách.',
        price: '2.500.000đ',
    ...
    },
    {
        ...
        description: 'Khóa học chuyên sâu về chăm sóc, tuốt lá và uốn tỉa mai vàng để hoa nở đúng Mùng 1 Tết.',
        price: '1.800.000đ',
    ...
    {
        id: 6,
        title: 'Cắm Hoa Phối Màu',
        description: 'Học cách phối màu sắc hoa tươi hiện đại, phá cách, phù hợp với không gian nội thất trẻ trung.',
        price: '650.000đ',
    ...
    <div class="flex-1">
        <div
            ...
            <p class="text-base text-gray-500">Hiển thị <span class="font-bold text-[#181111] dark:text-white">{{
                    courses.length }}</span> khóa học phù hợp</p>
